...
const char *MAIN_WIN_CLASS_NAME = "Raster-Based Global Illumination";
...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE prevInstance, LPWSTR cmdLine, int cmdShow) 
{
   ...
   int height = 568;
	...
	HWND hwnd = CreateWindowA(MAIN_WIN_CLASS_NAME, "D3D11 GI Renderer", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, NULL, NULL, hInstance, NULL);
